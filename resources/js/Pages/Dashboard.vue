            ...
            <table class="min-w-full divide-y divide-gray-200 mx-16">
                ...
                <tbody class="bg-white divide-y divide-gray-200 overflow-y-scroll">
                    <tr v-for="subscriber in model.recent_subscribers" :key="subscriber.email" class="hover:bg-gray-100">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900">
                                <span v-for="tag in subscriber.tags" :key="tag.id" class="inline-flex items-center justify-cent px-2 py-1 mr-2 text-xs font-bold leading-none text-white bg-gray-400 rounded-full mb-2">
                                    {{ tag.title }}
                                </span>
                            </div>
                        </td>
